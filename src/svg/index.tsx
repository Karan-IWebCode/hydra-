...
export const XSmallArrow = () => {
    return(
        <svg width="33" height="27" viewBox="0 0 33 27" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M30.4584 13.4999L2.54169 13.4999M30.4584 13.4999L19.2917 24.6666M30.4584 13.4999L19.2917 2.33325" stroke="#C0B7E8" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    )
}
...
export const FooterVerticalLine = () => {
    return(
        <svg width="6" height="197" viewBox="0 0 6 197" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const FormVector = () => {
    return(
        <svg width="414" height="2" viewBox="0 0 414 2" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const HeaderGroup = () => {
    return(
        ...
        <g clip-path="url(#clip0_50_212)" filter="url(#filter0_d_50_212)">
        <path d="M106.772 41.2579C108.108 48.9756 99.9123 46.92 99.9123 46.92C96.4822 37.2547 90.9941 38.1563 90.9941 38.1563C95.2907 41.2939 95.6157 43.9627 95.6157 43.9627C84.17 35.8482 68.6082 42.3759 62.6868 45.4413C59.365 40.753 52.6493 30.2582 55.0323 25.4977C58.1735 19.2586 64.5643 22.8289 64.5643 22.8289C77.4904 22.6126 76.7682 17.9963 76.7682 17.9963C73.3381 20.6651 63.2284 17.9963 63.2284 17.9963C72.0022 17.9963 75.7212 14.4259 75.7212 14.4259C69.1859 16.0488 61.8925 9.08839 61.8925 9.08839C59.2206 -4.58003 46.8723 1.22635 46.8723 1.22635C54.599 -0.108037 52.541 8.07859 52.541 8.07859C42.8645 11.5047 43.7672 16.9865 43.7672 16.9865C46.9084 12.6948 49.5803 12.3703 49.5803 12.3703C40.7343 24.8125 49.2553 42.1234 51.7828 46.6315C47.1612 49.8412 36.3293 56.9098 31.455 54.4574C25.2086 51.3198 28.7831 44.9364 28.7831 44.9364C28.6387 32.0254 24.0171 32.7467 24.0171 32.7467C26.6889 36.1728 24.0171 46.2708 24.0171 46.2708C24.0171 37.5072 20.4426 33.7925 20.4426 33.7925C22.0674 40.3202 15.0989 47.6052 15.0989 47.6052C1.41461 50.274 7.2277 62.608 7.2277 62.608C5.89178 54.8902 14.0879 56.9459 14.0879 56.9459C17.518 66.6111 23.0061 65.7095 23.0061 65.7095C18.7095 62.5719 18.3845 59.9032 18.3845 59.9032C30.4801 68.4865 47.1973 60.6966 52.2521 57.9557C55.6461 62.8244 61.9647 72.8503 59.6178 77.5026C56.4766 83.7417 50.0858 80.1714 50.0858 80.1714C37.1597 80.3156 37.8819 84.9319 37.8819 84.9319C41.312 82.2631 51.4217 84.9319 51.4217 84.9319C42.6479 84.9319 38.9289 88.5023 38.9289 88.5023C45.4642 86.8794 52.7576 93.8398 52.7576 93.8398C55.4295 107.508 67.7778 101.702 67.7778 101.702C60.0511 103.036 62.1091 94.8496 62.1091 94.8496C71.7856 91.4235 70.8829 85.9417 70.8829 85.9417C67.7417 90.2333 65.0698 90.5579 65.0698 90.5579C73.7353 78.4042 65.7558 61.5621 63.0479 56.6213C67.9583 53.1952 77.8875 47.0642 82.473 49.3723C88.7194 52.51 85.1449 58.8934 85.1449 58.8934C85.2893 71.8044 89.9109 71.0831 89.9109 71.0831C87.239 67.657 89.9109 57.559 89.9109 57.559C89.9109 66.3226 93.4854 70.0373 93.4854 70.0373C91.8606 63.5096 98.8291 56.2246 98.8291 56.2246C112.586 53.5919 106.772 41.2579 106.772 41.2579Z" fill="url(#paint0_linear_50_212)"/>
        </g>
        <g clip-path="url(#clip1_50_212)">
        <path d="M123 29H125.321V56.4049H132.251V29H134.572V75H132.251V58.7131H125.321V75H123V29Z" fill="url(#paint1_linear_50_212)"/>
        <path d="M151.733 29L145.98 58.7131V75H143.659V58.7131L137.873 29H139.998L144.836 53.7717L149.641 29H151.733Z" fill="url(#paint2_linear_50_212)"/>
        <path d="M161.997 75H155.034V29H161.964C164.547 29 166.573 31.0481 166.573 33.5837V70.3837C166.606 72.8869 164.547 75 161.997 75ZM157.355 31.3081V72.6919H161.964C163.206 72.6919 164.285 71.6516 164.285 70.3837V33.5837C164.285 32.3484 163.239 31.2756 161.964 31.2756H157.355V31.3081Z" fill="url(#paint3_linear_50_212)"/>
        <path d="M181.806 75H179.42L175.334 58.7131H172.555V75H170.234V29H177.164C179.747 29 181.773 31.0481 181.773 33.5837V54.0968C181.773 56.4049 179.975 58.3555 177.687 58.6155L181.806 75ZM172.555 56.4049H177.164C178.406 56.4049 179.485 55.3647 179.485 54.0968V33.5837C179.485 32.3484 178.439 31.2756 177.164 31.2756H172.555V56.4049Z" fill="url(#paint4_linear_50_212)"/>
        <path d="M188.801 58.7131L187.2 75H185.108L189.749 29H194.358L198.967 75H196.875L195.274 58.7131H188.801ZM192.495 31.3081H191.58L189.063 56.4049H195.012L192.495 31.3081Z" fill="url(#paint5_linear_50_212)"/>
        </g>
        <defs>
        <filter id="filter0_d_50_212" x="0" y="0" width="114" height="119" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
        ...
        <linearGradient id="paint0_linear_50_212" x1="56.9966" y1="0.0012207" x2="56.9966" y2="102.927" gradientUnits="userSpaceOnUse">
        <stop stop-color="#C0B7E8"/>
        <stop offset="1" stop-color="#8176AF"/>
        </linearGradient>
        <linearGradient id="paint1_linear_50_212" x1="128.786" y1="29" x2="128.786" y2="75" gradientUnits="userSpaceOnUse">
        <stop stop-color="#C0B7E8"/>
        <stop offset="1" stop-color="#8176AF"/>
        </linearGradient>
        <linearGradient id="paint2_linear_50_212" x1="144.803" y1="29" x2="144.803" y2="75" gradientUnits="userSpaceOnUse">
        <stop stop-color="#C0B7E8"/>
        <stop offset="1" stop-color="#8176AF"/>
        </linearGradient>
        <linearGradient id="paint3_linear_50_212" x1="160.804" y1="29" x2="160.804" y2="75" gradientUnits="userSpaceOnUse">
        <stop stop-color="#C0B7E8"/>
        <stop offset="1" stop-color="#8176AF"/>
        </linearGradient>
        <linearGradient id="paint4_linear_50_212" x1="176.02" y1="29" x2="176.02" y2="75" gradientUnits="userSpaceOnUse">
        <stop stop-color="#C0B7E8"/>
        <stop offset="1" stop-color="#8176AF"/>
        </linearGradient>
        <linearGradient id="paint5_linear_50_212" x1="192.037" y1="29" x2="192.037" y2="75" gradientUnits="userSpaceOnUse">
        <stop stop-color="#C0B7E8"/>
        <stop offset="1" stop-color="#8176AF"/>
        </linearGradient>
...
export const BackImage = () => {
    return (
        ...
        <path d="M1439.5 282C1315.17 293.333 1084.71 388.757 957 494C795 627.5 543.167 473 391 376C283.5 309 55.3 242.7 2.5 513.5" stroke="url(#paint0_linear_155_31)" stroke-opacity="0.13" stroke-width="6"/>
        <path d="M4.5 366C46.3333 297.5 214.9 191.2 554.5 314C894.1 436.8 1286 157.833 1439.5 3" stroke="url(#paint1_linear_155_31)" stroke-opacity="0.13" stroke-width="6"/>
        <defs>
        <linearGradient id="paint0_linear_155_31" x1="1439.5" y1="282.631" x2="2.5" y2="282.631" gradientUnits="userSpaceOnUse">
        <stop stop-color="#343045"/>
        <stop offset="0.348958" stop-color="#C0B7E8"/>
        <stop offset="0.6875" stop-color="#8176AF"/>
        <stop offset="1" stop-color="#343045"/>
        </linearGradient>
        <linearGradient id="paint1_linear_155_31" x1="1439.5" y1="3.86474" x2="4.5" y2="3.86467" gradientUnits="userSpaceOnUse">
        <stop stop-color="#343045"/>
        <stop offset="0.348958" stop-color="#C0B7E8"/>
        <stop offset="0.6875" stop-color="#8176AF"/>
        <stop offset="1" stop-color="#343045"/>
